...
describe('declarative rule module language', () => {
  it('instantiates module data with parameters, bindings, indices, patches and artifacts', () => {
  ...
  it('survives JSON round-trip and composes modules in declared order', () => {
    ...
    const result = composeWorldModules(BASE_WORLD, [
      ...
      { definition: second, bindings: { priorTrack: 'track:fixture' } },
    ]);
  ...
  it('publishes an MCP contract that forces validation and compilation', () => {

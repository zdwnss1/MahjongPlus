...
const constraintId = 'service.riichi-wait-classification.validate';
const rewriteId = 'service.riichi-wait-classification.record';
const trackId = 'track:wait-classifications';
...
export const RIICHI_WAIT_CLASSIFICATION_MODULE: RuleModuleDefinition = {
  id: 'service.riichi-wait-classification',
  version: '1.0.0',
  title: 'Riichi source-group wait classification',
  ...
  patches: ['interpretation.submit-response', 'interpretation.submit-direct'].flatMap((actionId) => [
    {
